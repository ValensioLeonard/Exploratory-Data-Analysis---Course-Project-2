...
## Search for "vehicle" in the merged data under SCC.Level.Two column
vec <- grep("vehicle", final$SCC.Level.Two, ignore.case = T)

##  Subset the data, and take only the data with vehicle
final <- final[vec, ]

## Subset and take the Baltimore City data
final <- final[final$fips == "24510",]
